    ...
    <section className="vh-100">
        <div className="container-fluid h-custom">
          <div className="d-flex justify-content-center align-items-center h-100">
            ...
            <div className="col-md-8 col-lg-6 col-xl-4 offset-xl-1 row">
              <form action="#">
                <div className="d-flex flex-row align-items-center justify-content-center justify-content-lg-start">
                  <p className="lead fw-normal mb-0 me-3">inicia sesión con</p>
                  <button type="button">
                    <img src="../f.png" alt="" width="50px" height="50px"/>
                  </button>
      
                  <button type="button" >
                    <img src="../t.png" alt="" width="50px" height="50px"/>
                  </button>
      
                  <button type="button">
                    <img src="../i.png" alt="" width="50px" height="50px"/>
                  </button>
                </div>
        ...
        <div
          ...
          <div className="text-white mb-3 mb-md-0">
            Copyright © 2023. Restaurante App.
          </div>
        </div>
      </section>
  )
